...
<a href="javascript:showhide('hovertobegin')">Hover your mouse here to begin.</a>
  <span class="tooltipRtext">Good work! <br/> You followed instructions well. <br/> Now "click" to get started. </span>
</span>
...
**Warning**
If you use filter() and you need to run a Q-Q plot on the filtered level, remember to use droplevels() or the Q-Q plot won't work. This prevents some sort of error where the filtered data technically remembers what you filtered out and prevents you from making a  Q-Q plot.
...
[How to subtract two lists](https://www.oreilly.com/library/view/the-r-book/9780470510247/ch002-sec073.html)
