...
This can be used for anything the other tests aren't appropriate for. Technically, you can use it even when those other tests are appropriate, but this is a sub-par option to the others.
