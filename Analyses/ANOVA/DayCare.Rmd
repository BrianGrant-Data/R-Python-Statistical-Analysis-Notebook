...
There are three recorded factors that could possibly effect how many parents are late: Treatment, Center, Week, and Status. The Treatment factor has two levels, *Control* and *Fine*. The  Center factor has 12 levels, one for each private daycare in the study. The Week factor has 20 levels. 
...
```{r}
Late.aov <- aov(
  No.ofLateChildren ~     + Treatment + as.factor(Center) + as.factor(Week),
  data = Late
  )
